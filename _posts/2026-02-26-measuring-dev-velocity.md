...
Here's two years of fortnightly sprints from January 2024 onwards, showing story points, stories closed, and bugs closed all in one view:

<div class="chart-container"><canvas id="combinedChart" style="max-width:100%; height:400px;"></canvas>
<script>
(function() {
  var labels = ["Dec 23","","Jan 24","","Feb 24","","Mar 24","","Apr 24","","May 24","","Jun 24","","Jul 24","","Aug 24","","Sep 24","","Oct 24","","Nov 24","","Nov 24","","Dec 24","","Jan 25","","Feb 25","","Mar 25","","Apr 25","","May 25","","Jun 25","","Jul 25","","Aug 25","","Sep 25","","Oct 25","","Nov 25","","Nov 25","","Dec 25","","Jan 26",""];
  var points = [3,8,16,21,3,13,0,0,0,0,13,5,5,0,8,0,8,7,17,9,0,20,8,13,0,8,0,0,0,0,8,5,13,0,8,10,3,28,0,0,8,0,41,0,0,13,8,0,5,5,2,0,0,14,8,0];
  var stories = [1,1,2,4,1,2,0,0,0,0,2,1,1,0,1,0,2,2,4,3,0,1,1,1,0,1,0,0,0,0,1,1,1,0,1,2,1,2,0,0,1,0,3,0,0,2,2,0,1,1,1,0,0,3,2,0];
  var bugs = [0,0,0,2,0,2,2,0,2,0,0,3,1,2,1,1,0,3,2,3,0,0,0,1,0,0,3,8,2,1,2,4,3,2,0,0,1,0,4,2,4,0,0,1,2,1,1,4,4,6,1,0,1,2,1,0];
  var sma = [null,null,null,12.0,12.0,13.2,9.2,4.0,3.2,0.0,3.2,4.5,5.8,5.8,4.5,3.2,4.0,5.8,8.0,10.2,8.2,11.5,9.2,10.2,10.2,7.2,5.2,2.0,2.0,0.0,2.0,3.2,6.5,6.5,6.5,7.8,5.2,12.2,10.2,7.8,9.0,2.0,12.2,12.2,10.2,13.5,5.2,5.2,6.5,4.5,3.0,3.0,1.8,4.0,5.5,5.5];
  new Chart(document.getElementById('combinedChart'), {
    type: 'bar',
    data: {
      labels: labels,
      datasets: [
        { label: 'Story Points', data: points, backgroundColor: 'rgba(245,166,35,0.5)', borderColor: 'rgba(245,166,35,1)', borderWidth: 1, order: 4 },
        { label: 'Stories Closed', data: stories, backgroundColor: 'rgba(80,200,220,0.5)', borderColor: 'rgba(80,200,220,1)', borderWidth: 1, order: 3 },
        { label: 'Bugs Closed', data: bugs, backgroundColor: 'rgba(180,100,255,0.5)', borderColor: 'rgba(180,100,255,1)', borderWidth: 1, order: 2 },
        { label: 'Points SMA (8wk)', data: sma, type: 'line', borderColor: 'rgba(255,255,255,0.6)', borderWidth: 2, pointRadius: 0, fill: false, tension: 0.3, order: 1 }
      ]
    },
    options: {
      responsive: true,
...
The shaded zones are annual leave. The amber dashed line marks when I started experimenting with AI at work (around September 2025), and the red line is when I got serious about it (January 2026).

You can see story points (amber), stories closed (cyan), and bugs closed (purple) all in one place, with the white SMA line tracking the overall points trend.
